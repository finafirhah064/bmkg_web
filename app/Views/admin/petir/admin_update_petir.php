                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-control" id="tanggal" name="tanggal"
                                     value="<?= (strtotime($petir['tanggal'])) ? date('Y-m-d', strtotime($petir['tanggal'])) : '' ?>" required>


                            </div>

                            <div class="mb-4">
                                <label for="waktu_sambaran">Waktu Sambaran</label>
                               <input type="time" class="form-control" id="waktu_sambaran" name="waktu_sambaran"
                                     value="<?= $petir['waktu_sambaran'] ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.000001" class="form-control" id="latitude" name="latitude"
                                    value="<?= $petir['latitude']?>" required>
                            </div>

                            <div class="mb-4">
                                <label for="longitude">Longitude</label>
                                <input type="number" step="0.000001" class="form-control" id="longitude" name="longitude"
                                    value="<?= $petir['longitude']?>" required>
                            </div>

                            <div class="mb-4">
                                <label for="jenis_petir">Jenis Petir</label>
