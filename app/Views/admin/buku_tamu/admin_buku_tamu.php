<main class="content">
                ...
                <div class="d-flex align-items-center">
                    <form class="navbar-search form-inline" method="GET" action="<?= base_url('buku_tamu') ?>">
                        <div class="input-group input-group-merge search-bar">
                            ...
                            <input type="text" name="keyword" class="form-control" placeholder="Cari nama atau instansi..." value="<?= esc($keyword ?? '') ?>">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="<?= base_url('buku_tamu/export_excel') ?>" class="btn btn-outline-success d-inline-flex align-items-center me-2">
