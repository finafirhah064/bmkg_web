...
<main class="content">
    ...
    <td>
       <img src="<?= base_url('uploads/gambar_hilal/' . $gambar['path_gambar']); ?>" alt="Gambar Hilal" style="width: 100px; height: auto;">
    ...
    <td>
        <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal<?= $gambar['id_gambar_hilal']; ?>">Edit</a>
        <a href="<?= base_url('hilal/delete_gambar/' . $gambar['id_gambar_hilal']); ?>" class="btn btn-danger btn-sm">Delete</a>
    </td>
</tr>
        ...
        <div class="modal fade" id="editModal<?= $gambar['id_gambar_hilal']; ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('hilal/update_gambar/' . $gambar['id_gambar_hilal']); ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="keterangan" class="form-label">Keterangan</label>
                                <input type="text" class="form-control" name="keterangan" value="<?= $gambar['keterangan']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="gambar_utama" class="form-label">Jadikan Gambar Utama</label>
