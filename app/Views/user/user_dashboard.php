<main>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h1 class="fw-bolder">Dashboard Informasi BMKG</h1>
                    <h2 class="lead fw-normal text-muted mb-5">Pantau data cuaca, suhu, gempa, dan layanan publik secara
                        real-time dari seluruh Indonesia.</h2>
                    <!-- Button Modal -->
            ...
            <div class="row justify-content-center mb-5 mb-lg-6">
                <div class="col-6 col-md-3 text-center mb-4">
                    <div class="icon icon-shape bg-white shadow-lg rounded mb-4">
                        <i class="fas fa-bolt-lightning fa-2x text-bmkg"></i>
                    </div>
                    <h3 class="fw-bolder">1.827</h3>
                    <p class="text-gray">Total Sambaran Petir</p>
                </div>
                <div class="col-6 col-md-3 text-center mb-4">
                    <div class="icon icon-shape bg-white shadow-lg rounded mb-4">
                        <i class="fa-solid fa-temperature-quarter fa-2x text-bmkg"></i>
                    </div>
                    <h3 class="fw-bolder">33.4°C</h3>
                    <p class="text-gray">Suhu Tertinggi Hari Ini</p>
                </div>
                <div class="col-6 col-md-3 text-center">
                    <div class="icon icon-shape bg-white shadow-lg rounded mb-4">
                        <i class="fa-solid fa-gauge-high fa-2x text-bmkg"></i>
                    </div>
                    <h3 class="fw-bolder">1009 hPa</h3>
                    <p class="text-gray">Tekanan Udara</p>
                </div>
                <div class="col-6 col-md-3 text-center">
                    <div class="icon icon-shape bg-white shadow-lg rounded mb-4">
                        <i class="fa-solid fa-sun fa-2x text-bmkg"></i>
                    </div>
                    <h3 class="fw-bolder">05:31 - 17:52</h3>
                    <p class="text-gray">Terbit & Tenggelam</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section section-lg bg-soft pt-0">
        <div class="container">
            <div class="row justify-content-center mb-5 mb-lg-6">
                <!-- Judul sebelum berita kegiatan -->
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-lg-8">
                        <h2 class="fw-bold text-dark mb-3">Berita Kegiatan</h2>
                        <p class="text-muted">Informasi terbaru dari kegiatan dan pengamatan yang dilakukan oleh BMKG.
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-5">
                        <div class="card berita-card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                            <div class="berita-image-wrapper">
                                <img src="./assets/img/berita1.jpg" alt="Judul Berita" class="img-fluid berita-img">
                            </div>
                            <div class="card-body p-4">
                                <h5 class="card-title fw-semibold mb-2 text-dark">Judul Berita Kegiatan Resmi</h5>
                                <p class="text-muted small mb-3">
                                    <i class="fas fa-calendar-alt me-1"></i> 27 Mei 2025
                                </p>
                                <p class="card-text berita-ringkasan" style="min-height: 72px;">
                                    Ringkasan berita ditampilkan di sini dalam 2–3 baris untuk menarik pembaca secara
                                    elegan dan ringkas.
                                </p>
                                <a href="#" class="btn btn-outline-primary rounded-pill btn-sm mt-2">
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 mb-lg-6">
                <div class="col-12 text-center">
                    ...
                    <p class="lead px-lg-8">You get all Bootstrap components fully customized. Besides, you receive
                        numerous plugins out of the box and ready to use.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="bootstrap" role="img" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="sass" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <path fill="currentColor"
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="gulp" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
                                <path fill="currentColor"
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="accessible-icon" role="img" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512">
                                <path fill="currentColor"
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="html5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                <path fill="currentColor"
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card bg-white shadow-soft text-primary rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="js-square" role="img" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512">
                                <path fill="currentColor"
