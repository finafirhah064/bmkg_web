...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Stasiun Geofisika Kelas III Malang</title>
                    ...
                    <ul class="navbar-nav ms-auto navbar-nav-hover align-items-lg-center">
                        ...
                        <li class="nav-item dropdown me-3">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="informasiDropdown">
                                <li><a class="dropdown-item" href="<?= base_url('user/beritakegiatan') ?>">Berita &
                                        Pengumuman</a></li>
                                <li><a class="dropdown-item" href="<?= base_url('user/tentangbmkg') ?>">Tentang BMKG</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown me-3">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="layananDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?= base_url('pengajuan_surat') ?>">Pengajuan
                                        Surat</a></li>
                                <li><a class="dropdown-item" href="<?= base_url('cek_status_surat') ?>">Cek Status
                                        Surat</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dataDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?= base_url('/user/terbit-tenggelam'); ?>">Terbit &
                                        Tenggelam</a></li>
